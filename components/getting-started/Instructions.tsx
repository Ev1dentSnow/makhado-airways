...
export default function Instructions() {
    return (
        <div className="w-screen h-fit flex flex-col items-center gap-16 pt-24 pb-32 px-16">

            <section className="flex flex-col items-center gap-8 pb-6">
            ...
            <section className="w-full sm:w-3/4 flex flex-col gap-12">
