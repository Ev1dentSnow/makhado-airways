			...
			<div className="h-screen w-full overflow-hidden">
				<Parallax speed={-20}>
					...
					<header className="absolute inset-0 flex flex-col items-center justify-center pt-12">
						<h4 className="text-4xl sm:text-6xl text-center mb-8">Welcome to</h4>
						<h1 className="text-6xl sm:text-8xl text-center font-bold tracking-wide mb-8">Makhado Airways</h1>
						<h4 className="text-2xl sm:text-3xl text-center font-medium tracking-wide mb-12 px-6 sm:px-0">&quot;South Africa&apos;s <span className="italic">favourite</span> virtual airline&quot;</h4>
